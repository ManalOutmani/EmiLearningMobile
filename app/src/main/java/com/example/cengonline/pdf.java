...
public class pdf extends AppCompatActivity {
    ...
    String link="",courseList="",course="";
    PDFView pdfView;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pdf);
        course =getIntent().getStringExtra("title");
        courseList=getIntent().getStringExtra("productList");
        link=getIntent().getStringExtra("link");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle(courseList);
    ...
    class RetrievePDFStream extends AsyncTask<String, Void, InputStream> {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog.setTitle("Obtenant le support du cours...");
            progressDialog.setMessage("Attendez svp...");
